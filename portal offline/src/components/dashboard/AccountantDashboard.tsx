...
const AccountantDashboard = ({ user }: { user: LocalUser }) => {
  ...
  const handleApprove = async (requestId: string) => {
    ...
    try {
      await accountantApprove(requestId, user.id, comments);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-foreground mb-2">Chief Accountant Dashboard</h2>
        <p className="text-muted-foreground">Review and approve fee requests</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid gap-6">
          <div>
            <h3 className="text-xl font-semibold mb-4">Pending Approvals ({pendingRequests.length})</h3>
